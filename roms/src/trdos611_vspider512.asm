...
RMD_DRIVE   EQU     #02     ;ramdisc on drive A(#00),B(#01),C(#02),D(#03)

;------- ramdisc size (free space) --------
RMD_SIZE    EQU     #05F0   ;ramdisc size(only free sectors = full capacity - 16 sectors)
...
x3FF3       IN  A,(C)           ;а вот ЭТО,если бы он думал правильным местом,
            ...
            IFDEF   RAM_ZX_PROFI_1024
 ;           SAVEBIN "TR-DOS_6.11Q_ZX_PROFI1024.ROM",0,#4000
			SAVEBIN "TR-DOS_6.11Q_VSPIDER512.ROM",0,#4000
            ENDIF
            
            IFDEF   RAM_PENTAGON_1024
            SAVEBIN "TR-DOS_6.11Q_PENTAGON1024.ROM",0,#4000
            ENDIF
            
            IFDEF   RAM_SCORPION_1024
            SAVEBIN "TR-DOS_6.11Q_SCORPION1024.ROM",0,#4000
            ENDIF
            
            IFDEF   RAM_ZXM_PHOENIX
            SAVEBIN "TR-DOS_6.11Q_ZXM_PHOENIX.ROM",0,#4000
            ENDIF
